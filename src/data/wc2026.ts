  ...
  knockoutRounds: [
    {
      ...
      matches: [
        ...
        { id: 'm83', date: '2026-07-02', home: { type: 'group-rank', group: 'K', rank: 2 }, away: { type: 'group-rank', group: 'L', rank: 2 }, odds: { home: 0.574, draw: 0.264, away: 0.164, url: 'https://polymarket.com/event/fifwc-prt-hrv-2026-07-02' }, kickoff: '2026-07-02T23:00Z', homeTeam: 'POR', awayTeam: 'CRO', score: { home: 2, away: 1 }, goals: [{ team: 'CRO', player: "Ivan Perisic", minute: "53'" }, { team: 'POR', player: "Cristiano Ronaldo", minute: "68'", penalty: true }, { team: 'POR', player: "Gonçalo Ramos", minute: "90'+4'" }] },
        { id: 'm84', date: '2026-07-02', home: { type: 'group-rank', group: 'H', rank: 1 }, away: { type: 'group-rank', group: 'J', rank: 2 }, odds: { home: 0.721, draw: 0.186, away: 0.089, url: 'https://polymarket.com/event/fifwc-esp-aut-2026-07-02' }, kickoff: '2026-07-02T19:00Z', homeTeam: 'ESP', awayTeam: 'AUT', score: { home: 3, away: 0 }, goals: [{ team: 'ESP', player: "Mikel Oyarzabal", minute: "36'" }, { team: 'ESP', player: "Pedro Porro", minute: "66'" }, { team: 'ESP', player: "Mikel Oyarzabal", minute: "89'" }] },
        { id: 'm85', date: '2026-07-02', home: { type: 'group-rank', group: 'B', rank: 1 }, away: { type: 'best-third', groups: ['E', 'F', 'G', 'I', 'J'] }, odds: { home: 0.489, draw: 0.304, away: 0.211, url: 'https://polymarket.com/event/fifwc-che-alg-2026-07-02' }, kickoff: '2026-07-03T03:00Z', homeTeam: 'SUI', awayTeam: 'ALG', score: { home: 2, away: 0 }, goals: [{ team: 'SUI', player: "Breel Embolo", minute: "10'" }, { team: 'SUI', player: "Dan Ndoye", minute: "46'" }] },
        { id: 'm86', date: '2026-07-03', home: { type: 'group-rank', group: 'J', rank: 1 }, away: { type: 'group-rank', group: 'H', rank: 2 }, odds: { home: 0.865, draw: 0.105, away: 0.034, url: 'https://polymarket.com/event/fifwc-arg-cvi-2026-07-03' }, kickoff: '2026-07-03T22:00Z', homeTeam: 'ARG', awayTeam: 'CPV', score: { home: 3, away: 2 }, afterExtraTime: true, goals: [{ team: 'ARG', player: "Lionel Messi", minute: "29'" }, { team: 'CPV', player: "Deroy Duarte", minute: "59'" }, { team: 'ARG', player: "Lisandro Martínez", minute: "92'" }, { team: 'CPV', player: "Sidny Lopes Cabral", minute: "103'" }, { team: 'ARG', player: "Diney Borges", minute: "111'", ownGoal: true }] },
        { id: 'm87', date: '2026-07-03', home: { type: 'group-rank', group: 'K', rank: 1 }, away: { type: 'best-third', groups: ['D', 'E', 'I', 'J', 'L'] }, odds: { home: 0.675, draw: 0.225, away: 0.105, url: 'https://polymarket.com/event/fifwc-col-gha-2026-07-03' }, kickoff: '2026-07-04T01:30Z', homeTeam: 'COL', awayTeam: 'GHA', score: { home: 1, away: 0 }, goals: [{ team: 'COL', player: "Jhon Arias", minute: "14'" }] },
        { id: 'm88', date: '2026-07-03', home: { type: 'group-rank', group: 'D', rank: 2 }, away: { type: 'group-rank', group: 'G', rank: 2 }, odds: { home: 0.255, draw: 0.345, away: 0.405, url: 'https://polymarket.com/event/fifwc-aus-egy-2026-07-03' }, kickoff: '2026-07-03T18:00Z', homeTeam: 'AUS', awayTeam: 'EGY', score: { home: 1, away: 1 }, afterExtraTime: true, penalties: { home: 2, away: 4 }, goals: [{ team: 'EGY', player: "Emam Ashour", minute: "13'" }, { team: 'AUS', player: "Mohamed Hany", minute: "55'", ownGoal: true }] },
      ],
    },
    {
      id: 'r16',
      ...
      matches: [
        ...
        { id: 'm91', date: '2026-07-05', home: { type: 'match-winner', match: 'm76' }, away: { type: 'match-winner', match: 'm78' }, odds: { home: 0.545, draw: 0.265, away: 0.195, url: 'https://polymarket.com/event/fifwc-bra-nor-2026-07-05' }, kickoff: '2026-07-05T20:00Z', homeTeam: 'BRA', awayTeam: 'NOR', score: { home: 1, away: 2 }, goals: [{ team: 'NOR', player: "Erling Haaland", minute: "79'" }, { team: 'NOR', player: "Erling Haaland", minute: "90'" }, { team: 'BRA', player: "Neymar", minute: "90'+10'", penalty: true }] },
        { id: 'm92', date: '2026-07-05', home: { type: 'match-winner', match: 'm79' }, away: { type: 'match-winner', match: 'm80' }, odds: { home: 0.315, draw: 0.315, away: 0.375, url: 'https://polymarket.com/event/fifwc-mex-eng-2026-07-05' }, kickoff: '2026-07-06T00:00Z', homeTeam: 'MEX', awayTeam: 'ENG', score: { home: 2, away: 3 }, goals: [{ team: 'ENG', player: "Jude Bellingham", minute: "36'" }, { team: 'ENG', player: "Jude Bellingham", minute: "38'" }, { team: 'MEX', player: "Julián Quiñones", minute: "42'" }, { team: 'ENG', player: "Harry Kane", minute: "60'", penalty: true }, { team: 'MEX', player: "Raúl Jiménez", minute: "69'", penalty: true }] },
        { id: 'm93', date: '2026-07-06', kickoff: '2026-07-06T19:00Z', home: { type: 'match-winner', match: 'm83' }, away: { type: 'match-winner', match: 'm84' } , odds: { home: 0.225, draw: 0.265, away: 0.515, url: 'https://polymarket.com/event/fifwc-prt-esp-2026-07-06' } },
        { id: 'm94', date: '2026-07-06', kickoff: '2026-07-07T00:00Z', home: { type: 'match-winner', match: 'm81' }, away: { type: 'match-winner', match: 'm82' } , odds: { home: 0.385, draw: 0.275, away: 0.345, url: 'https://polymarket.com/event/fifwc-usa-bel-2026-07-06' } },
        { id: 'm95', date: '2026-07-07', kickoff: '2026-07-07T16:00Z', home: { type: 'match-winner', match: 'm86' }, away: { type: 'match-winner', match: 'm88' } , odds: { home: 0.715, draw: 0.205, away: 0.095, url: 'https://polymarket.com/event/fifwc-arg-egy-2026-07-07' } },
        { id: 'm96', date: '2026-07-07', kickoff: '2026-07-07T20:00Z', home: { type: 'match-winner', match: 'm85' }, away: { type: 'match-winner', match: 'm87' } , odds: { home: 0.275, draw: 0.315, away: 0.425, url: 'https://polymarket.com/event/fifwc-che-col-2026-07-07' } },
      ],
    },
    {
      id: 'qf',
      ...
      matches: [
        ...
        { id: 'm99', date: '2026-07-11', kickoff: '2026-07-11T21:00Z', home: { type: 'match-winner', match: 'm91' }, away: { type: 'match-winner', match: 'm92' } , odds: { home: 0.235, draw: 0.265, away: 0.515, url: 'https://polymarket.com/event/fifwc-nor-eng-2026-07-11' } },
