  ...
  knockoutRounds: [
    {
      ...
      matches: [
        ...
        { id: 'm86', date: '2026-07-03', home: { type: 'group-rank', group: 'J', rank: 1 }, away: { type: 'group-rank', group: 'H', rank: 2 }, odds: { home: 0.855, draw: 0.105, away: 0.035, url: 'https://polymarket.com/event/fifwc-arg-cvi-2026-07-03' }, kickoff: '2026-07-03T22:00Z', homeTeam: 'ARG', awayTeam: 'CPV', score: { home: 3, away: 2 }, afterExtraTime: true, goals: [{ team: 'ARG', player: "Lionel Messi", minute: "29'" }, { team: 'CPV', player: "Deroy Duarte", minute: "59'" }, { team: 'ARG', player: "Lisandro Martínez", minute: "92'" }, { team: 'CPV', player: "Sidny Lopes Cabral", minute: "103'" }, { team: 'ARG', player: "Diney Borges", minute: "111'", ownGoal: true }] },
        { id: 'm87', date: '2026-07-03', home: { type: 'group-rank', group: 'K', rank: 1 }, away: { type: 'best-third', groups: ['D', 'E', 'I', 'J', 'L'] }, odds: { home: 0.685, draw: 0.215, away: 0.105, url: 'https://polymarket.com/event/fifwc-col-gha-2026-07-03' }, kickoff: '2026-07-04T01:30Z', homeTeam: 'COL', awayTeam: 'GHA', score: { home: 1, away: 0 }, goals: [{ team: 'COL', player: "Jhon Arias", minute: "14'" }] },
    ...
    },
    {
      ...
      name: 'Round of 16',
      matches: [
        { id: 'm89', date: '2026-07-04', home: { type: 'match-winner', match: 'm74' }, away: { type: 'match-winner', match: 'm77' }, odds: { home: 0.045, draw: 0.125, away: 0.835, url: 'https://polymarket.com/event/fifwc-par-fra-2026-07-04' }, kickoff: '2026-07-04T21:00Z', homeTeam: 'PAR', awayTeam: 'FRA', score: { home: 0, away: 1 }, goals: [{ team: 'FRA', player: "Kylian Mbappé", minute: "70'", penalty: true }] },
        { id: 'm90', date: '2026-07-04', home: { type: 'match-winner', match: 'm73' }, away: { type: 'match-winner', match: 'm75' }, odds: { home: 0.205, draw: 0.285, away: 0.505, url: 'https://polymarket.com/event/fifwc-can-mar-2026-07-04' }, kickoff: '2026-07-04T17:00Z', homeTeam: 'CAN', awayTeam: 'MAR', score: { home: 0, away: 3 }, goals: [{ team: 'MAR', player: "Azzedine Ounahi", minute: "50'" }, { team: 'MAR', player: "Azzedine Ounahi", minute: "82'" }, { team: 'MAR', player: "Soufiane Rahimi", minute: "90'+8'" }] },
        { id: 'm91', date: '2026-07-05', home: { type: 'match-winner', match: 'm76' }, away: { type: 'match-winner', match: 'm78' }, odds: { home: 0.535, draw: 0.265, away: 0.205, url: 'https://polymarket.com/event/fifwc-bra-nor-2026-07-05' }, kickoff: '2026-07-05T20:00Z', homeTeam: 'BRA', awayTeam: 'NOR', score: { home: 1, away: 2 }, goals: [{ team: 'NOR', player: "Erling Haaland", minute: "79'" }, { team: 'NOR', player: "Erling Haaland", minute: "90'" }, { team: 'BRA', player: "Neymar", minute: "90'+10'", penalty: true }] },
        ...
        { id: 'm94', date: '2026-07-06', kickoff: '2026-07-07T00:00Z', home: { type: 'match-winner', match: 'm81' }, away: { type: 'match-winner', match: 'm82' } , odds: { home: 0.335, draw: 0.295, away: 0.375, url: 'https://polymarket.com/event/fifwc-usa-bel-2026-07-06' } },
