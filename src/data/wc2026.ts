  ...
  knockoutRounds: [
    {
      ...
      matches: [
        ...
        { id: 'm83', date: '2026-07-02', home: { type: 'group-rank', group: 'K', rank: 2 }, away: { type: 'group-rank', group: 'L', rank: 2 }, odds: { home: 0.586, draw: 0.249, away: 0.169, url: 'https://polymarket.com/event/fifwc-prt-hrv-2026-07-02' }, kickoff: '2026-07-02T23:00Z', homeTeam: 'POR', awayTeam: 'CRO', score: { home: 2, away: 1 }, goals: [{ team: 'CRO', player: "Ivan Perisic", minute: "53'" }, { team: 'POR', player: "Cristiano Ronaldo", minute: "68'", penalty: true }, { team: 'POR', player: "Gonçalo Ramos", minute: "90'+4'" }] },
        { id: 'm84', date: '2026-07-02', home: { type: 'group-rank', group: 'H', rank: 1 }, away: { type: 'group-rank', group: 'J', rank: 2 }, odds: { home: 0.739, draw: 0.181, away: 0.081, url: 'https://polymarket.com/event/fifwc-esp-aut-2026-07-02' }, kickoff: '2026-07-02T19:00Z', homeTeam: 'ESP', awayTeam: 'AUT', score: { home: 3, away: 0 }, goals: [{ team: 'ESP', player: "Mikel Oyarzabal", minute: "36'" }, { team: 'ESP', player: "Pedro Porro", minute: "66'" }, { team: 'ESP', player: "Mikel Oyarzabal", minute: "89'" }] },
        { id: 'm85', date: '2026-07-02', home: { type: 'group-rank', group: 'B', rank: 1 }, away: { type: 'best-third', groups: ['E', 'F', 'G', 'I', 'J'] }, odds: { home: 0.499, draw: 0.289, away: 0.204, url: 'https://polymarket.com/event/fifwc-che-alg-2026-07-02' }, kickoff: '2026-07-03T03:00Z', homeTeam: 'SUI', awayTeam: 'ALG', score: { home: 2, away: 0 }, goals: [{ team: 'SUI', player: "Breel Embolo", minute: "10'" }, { team: 'SUI', player: "Dan Ndoye", minute: "46'" }] },
        { id: 'm86', date: '2026-07-03', kickoff: '2026-07-03T22:00Z', home: { type: 'group-rank', group: 'J', rank: 1 }, away: { type: 'group-rank', group: 'H', rank: 2 }, homeTeam: 'ARG', awayTeam: 'CPV' , odds: { home: 0.855, draw: 0.115, away: 0.043, url: 'https://polymarket.com/event/fifwc-arg-cvi-2026-07-03' } },
        { id: 'm87', date: '2026-07-03', kickoff: '2026-07-04T01:30Z', home: { type: 'group-rank', group: 'K', rank: 1 }, away: { type: 'best-third', groups: ['D', 'E', 'I', 'J', 'L'] }, homeTeam: 'COL', awayTeam: 'GHA' , odds: { home: 0.645, draw: 0.235, away: 0.115, url: 'https://polymarket.com/event/fifwc-col-gha-2026-07-03' } },
        { id: 'm88', date: '2026-07-03', home: { type: 'group-rank', group: 'D', rank: 2 }, away: { type: 'group-rank', group: 'G', rank: 2 }, odds: { home: 0.285, draw: 0.335, away: 0.385, url: 'https://polymarket.com/event/fifwc-aus-egy-2026-07-03' }, kickoff: '2026-07-03T18:00Z', homeTeam: 'AUS', awayTeam: 'EGY', score: { home: 1, away: 1 }, afterExtraTime: true, penalties: { home: 2, away: 4 }, goals: [{ team: 'EGY', player: "Emam Ashour", minute: "13'" }, { team: 'AUS', player: "Mohamed Hany", minute: "55'", ownGoal: true }] },
      ],
    },
    {
      id: 'r16',
      ...
      matches: [
        ...
        { id: 'm91', date: '2026-07-05', kickoff: '2026-07-05T20:00Z', home: { type: 'match-winner', match: 'm76' }, away: { type: 'match-winner', match: 'm78' } , odds: { home: 0.515, draw: 0.265, away: 0.215, url: 'https://polymarket.com/event/fifwc-bra-nor-2026-07-05' } },
        ...
        { id: 'm94', date: '2026-07-06', kickoff: '2026-07-07T00:00Z', home: { type: 'match-winner', match: 'm81' }, away: { type: 'match-winner', match: 'm82' } , odds: { home: 0.365, draw: 0.295, away: 0.345, url: 'https://polymarket.com/event/fifwc-usa-bel-2026-07-06' } },
