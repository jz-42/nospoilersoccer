  ...
  knockoutRounds: [
    {
      ...
      matches: [
        ...
        { id: 'm77', date: '2026-06-30', home: { type: 'group-rank', group: 'I', rank: 1 }, away: { type: 'best-third', groups: ['C', 'D', 'F', 'G', 'H'] }, odds: { home: 0.775, draw: 0.155, away: 0.075, url: 'https://polymarket.com/event/fifwc-fra-swe-2026-06-30' }, kickoff: '2026-06-30T21:00Z', homeTeam: 'FRA', awayTeam: 'SWE', score: { home: 3, away: 0 }, goals: [{ team: 'FRA', player: "Kylian Mbappé", minute: "45'" }, { team: 'FRA', player: "Bradley Barcola", minute: "53'" }, { team: 'FRA', player: "Kylian Mbappé", minute: "74'" }] },
        { id: 'm78', date: '2026-06-30', home: { type: 'group-rank', group: 'E', rank: 2 }, away: { type: 'group-rank', group: 'I', rank: 2 }, odds: { home: 0.265, draw: 0.285, away: 0.455, url: 'https://polymarket.com/event/fifwc-civ-nor-2026-06-30' }, kickoff: '2026-06-30T17:00Z', homeTeam: 'CIV', awayTeam: 'NOR', score: { home: 1, away: 2 }, goals: [{ team: 'NOR', player: "Antonio Nusa", minute: "39'" }, { team: 'CIV', player: "Amad Diallo", minute: "74'" }, { team: 'NOR', player: "Erling Haaland", minute: "86'" }] },
        { id: 'm79', date: '2026-06-30', home: { type: 'group-rank', group: 'A', rank: 1 }, away: { type: 'best-third', groups: ['C', 'E', 'F', 'H', 'I'] }, odds: { home: 0.435, draw: 0.335, away: 0.235, url: 'https://polymarket.com/event/fifwc-mex-ecu-2026-06-30' }, kickoff: '2026-07-01T01:00Z', homeTeam: 'MEX', awayTeam: 'ECU', score: { home: 2, away: 0 }, goals: [{ team: 'MEX', player: "Julián Quiñones", minute: "22'" }, { team: 'MEX', player: "Raúl Jiménez", minute: "31'" }] },
        { id: 'm80', date: '2026-07-01', home: { type: 'group-rank', group: 'L', rank: 1 }, away: { type: 'best-third', groups: ['E', 'H', 'I', 'J', 'K'] }, odds: { home: 0.765, draw: 0.175, away: 0.065, url: 'https://polymarket.com/event/fifwc-eng-cdr-2026-07-01' }, kickoff: '2026-07-01T16:00Z', homeTeam: 'ENG', awayTeam: 'COD', score: { home: 2, away: 1 }, goals: [{ team: 'COD', player: "Brian Cipenga", minute: "7'" }, { team: 'ENG', player: "Harry Kane", minute: "75'" }, { team: 'ENG', player: "Harry Kane", minute: "86'" }] },
        ...
        { id: 'm82', date: '2026-07-01', home: { type: 'group-rank', group: 'G', rank: 1 }, away: { type: 'best-third', groups: ['A', 'E', 'H', 'I', 'J'] }, odds: { home: 0.435, draw: 0.295, away: 0.265, url: 'https://polymarket.com/event/fifwc-bel-sen-2026-07-01' }, kickoff: '2026-07-01T20:00Z', homeTeam: 'BEL', awayTeam: 'SEN', score: { home: 3, away: 2 }, afterExtraTime: true, goals: [{ team: 'SEN', player: "Habib Diarra", minute: "24'" }, { team: 'SEN', player: "Ismaïla Sarr", minute: "51'" }, { team: 'BEL', player: "Romelu Lukaku", minute: "86'" }, { team: 'BEL', player: "Youri Tielemans", minute: "89'" }, { team: 'BEL', player: "Youri Tielemans", minute: "120'+5'", penalty: true }] },
