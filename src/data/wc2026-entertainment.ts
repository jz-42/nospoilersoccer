...
export const wc2026Entertainment: Record<string, EntertainmentEntry> = {
  ...
  "m104": {
    entertainmentSummary: "It seems to have felt tense and weighty more than breezy, with the occasion giving it a charged edge. The entertainment sounded as if it came more from atmosphere and uncertainty than from a consistently lively rhythm.",
    entertainmentRating: 3,
    promptVersion: "entertainment-v2-agnostic-2026-06-27",
  },
  "m73": {
  ...
  "m74": {
    entertainmentSummary: "Tense and fairly cagey, with a sustained sense of uncertainty that seems to have made it more gripping than routine. It doesn't sound especially open or free-flowing, but the overall feel appears engaging through sheer competitive edge.",
    entertainmentRating: 4,
    promptVersion: "entertainment-v2-agnostic-2026-06-27",
  },
  "m75": {
  ...
  "m93": {
    entertainmentSummary: "Cagey and tense rather than free-flowing, with many reactions suggesting it felt fairly flat for long stretches. The occasion seemed to add some edge, but the overall viewing experience sounds closer to a grind than a lively spectacle.",
    entertainmentRating: 2,
    promptVersion: "entertainment-v2-agnostic-2026-06-27",
  },
  "m94": {
  ...
  "m98": {
    entertainmentSummary: "Fairly tense and competitive rather than free-flowing, with the occasion seeming to keep it engaging even when it was not constantly lively. It sounds more like a gripping, edge-of-the-seat watch than a chaotic spectacle.",
    entertainmentRating: 4,
    promptVersion: "entertainment-v2-agnostic-2026-06-27",
  },
  "m99": {
